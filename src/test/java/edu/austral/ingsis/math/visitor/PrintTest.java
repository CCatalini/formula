...
/*   @Test
    public void shouldPrintFunction3() {
        ...
        final String result = visitor.visit(new Mul(new Parenthesis(div), new Number(3)));
...
*/
  ...
  /*  @Test
    public void shouldPrintFunction4() {
        ...
        final String result = visitor.visit(new Pow(new Parenthesis(div), new Number(2)));
...
/*
    ...
    public void shouldPrintFunction6() {
        ...
        final String result = visitor.visit(new Sub(new Module(new Variable("value")), new Number(8)));
...
/*    @Test
    public void shouldPrintFunction8() {
        ...
        Sub sub = new Sub(new Number(5), new Variable("i"));
        final String result = visitor.visit(new Mul(new Parenthesis(sub), new Number(8)));
